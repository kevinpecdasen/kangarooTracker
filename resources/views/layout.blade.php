            ...
            <div class="row m-2 mt-5">
                ...
                <div class="col-2">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item {{ $sidePanelLink === "view_all" ? 'list-group-item-secondary' : '' }}"><a href="/view_all">View All</a></li>
                        <li class="list-group-item {{ $sidePanelLink === "add_kangaroo" ? 'list-group-item-secondary' : '' }}"><a href="/add_kangaroo">Add Kangaroo</a></li>
                    </ul>
                </div>
